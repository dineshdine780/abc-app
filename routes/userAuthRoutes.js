...
const validateCaptcha = (captcha, captchaInput) => {
  if (!captcha || !captchaInput) return false;
  return captcha.toUpperCase() === captchaInput.toUpperCase();
};


router.post("/register", async (req, res) => {
  try {
    let { name, phone, password, captcha, captchaInput } = req.body;
...
router.post("/login", loginLimiter, async (req, res) => {
  try {
    const { phone, password, captcha, captchaInput } = req.body;
